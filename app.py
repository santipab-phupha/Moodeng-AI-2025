    ...
    with st.spinner("✨ Generating caption…"):
        try:
            ...
            resp = client.models.generate_content(
                ...
                contents=[
                    gen_file,
                    "อธิบายภาพนี้สั้น ๆ ภาษาอังกฤษ แบบกำลังทำคลิป TikTok (ตอบเป็นประโยคสไตล์ MC ยาว ๆ ไม่ต้องใส่ # ไม่ต้องลากคำ เช่น ทุกคนนนน เอาให้ชัดเจนว่ารูปภาพนี้กำลังทำอะไร)"
                ],
            )
